      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-8">
          ...
          <div className="flex flex-wrap gap-6 text-sm font-semibold text-gray-500">
            ...
            <Link to="/commercial" className="hover:text-blue-900 transition-colors">About</Link>
        ...
        <div className="bg-gray-100 border p-6 rounded-2xl mb-10 text-center">
          <p className="text-black font-bold text-sm md:text-base uppercase tracking-tight">
        ...
        <div className="text-[11px] leading-relaxed text-gray-500 space-y-6 max-w-5xl mx-auto border-t border-gray-50 pt-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-100 gap-4">
            <div className="text-gray-400 font-medium text-center md:text-left">
              © 2026 | Greater London Financial Services Ltd | <Link to="/privacy-policy" className="text-blue-600 hover:underline">Privacy Policy</Link>
            </div>
            <div className="flex gap-4">
              <span className="px-2 py-1 bg-gray-100 rounded text-[9px] font-bold uppercase tracking-wider">FCA No. 1023239</span>
              <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded text-[9px] font-bold uppercase tracking-wider">Whole of Market</span>
            </div>
          </div>
        </div>
      </div>
